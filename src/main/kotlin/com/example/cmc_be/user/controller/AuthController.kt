...
class AuthController(
    ...
    fun signUpUser(@Valid @RequestBody signUpUserDto: SignUpUserDto): CommonResponse<UserTokenDto> {
    ...
    fun logInUser(@Valid @RequestBody loginUserDto: LoginUserDto): CommonResponse<UserTokenDto> {
    ...
    fun checkEmail(@RequestBody checkEmailDto: CheckEmailDto): CommonResponse<String> {
    ...
    @ApiErrorCodeExample()
    fun modifyPassword(@Valid @RequestBody modifyPasswordDto: ModifyPasswordDto): CommonResponse<String> {
