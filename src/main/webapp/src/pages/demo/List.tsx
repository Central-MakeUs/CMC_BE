                    ...
                    <>
                        <Row.Custom label={'계정 생성기간'}>
                            <FlexBox gap={16} justify={'flex-start'}>
                                <DateEasySelect onChange={setRegisterDate} name={'registerDate'}
                                                resetKey={dateEasySelectResetKey}/>
                                {renderResigisterDatePicker({placeholder: '기간을 선택해주세요'})}
                            </FlexBox>
                        </Row.Custom>
                        <Row.Custom label={'로그인 기간'}>
                            <FlexBox gap={16} justify={'flex-start'}>
                                <DateEasySelect onChange={setLoginDate} name={'loginDate'}
                                                resetKey={dateEasySelectResetKey}/>
                ...
                body={
                    <>
                        ...
                        <Table
                            ...
                            size={size}
                            data={getTableResponseType({src: data, totalCnt: size, page})}
                            status={httpStatus}
                            renderColumnData={{
